                        ...
                        <div className="container-fluid">
                            <div className="row">
                              ...
                              <CommenDoubleView wrapClass = "right-side-wrapper col-sm-12 col-md-6" contClass = "right-side-container"
                                    titleClass = "title-wraper white" proName = "Get the latest CDC response to COVID-19. " linkClass = "links-wrapper white" learnMore = "Learn More" 
                                    buyNow = "Get more info" topLogoWr = "d-none" tvShowLogo = "d-none"/>					
                            </div>
                        </div> 
                    </section>
        );
